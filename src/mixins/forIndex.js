...
export default {
  methods: {
     ...
     */
    async _setVisibleOfModal(record, visibleField, submoduleName, moduleName, merge) {
    ...
    async _mergeCurrentItem(payload, visibleField, submoduleName, moduleName) {
      await this._setVisibleOfModal(payload, visibleField, submoduleName, moduleName, true)
    }
  }
}
