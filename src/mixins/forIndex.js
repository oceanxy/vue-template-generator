...
export default {
  methods: {
     ...
     * @param [visibleField] {string} 默认值为打开编辑弹窗的可见性控制字段：visibilityOfEdit
     ...
     */
    async _setVisibilityOfModal(record, visibleField, submoduleName, moduleName, merge) {
     ...
     * @private
     */
    async _mergeCurrentItem(payload, visibleField, submoduleName, moduleName) {
      await this._setVisibilityOfModal(payload, visibleField, submoduleName, moduleName, true)
    }
  }
}
