...
export default Form.create({})({
  ...
  data() {
    return {
      modalProps: {
        width: 700,
        wrapClassName: 'bnm-modal-eidt-role-form'
      }
    }
  },
  computed: {},
            ...
            <Col span={12}>
              <Form.Item label="默认菜单">
                {this.form.getFieldDecorator('indexMenuId', {
                  initialValue: this.currentItem.indexMenuIds || []
                })(<CascaderMenu />)}
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item label="描述">
                {this.form.getFieldDecorator('roleDescribe', {
                  initialValue: this.currentItem.roleDescribe
                })(<Input placeholder="请输入名称" allowClear />)}
              </Form.Item>
            </Col>
            <Col span={12}>
