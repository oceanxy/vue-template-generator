...
import { Col, Form, Input, Row, Switch, Radio, DatePicker, Cascader } from 'ant-design-vue'
...
export default Form.create({})({
  ...
  data() {
    return {
      modalProps: {
        width: 700,
        wrapClassName: 'bnm-modal-eidt-user-form'
      },
      addressList: []
    }
  },
  ...
  async created() {
    if (!this.administrativeDivision.length) {
      this.$store.dispatch('common/getAdministrativeDivision')
    }
  },
  watch: {
    visible: {
      ...
      async handler(value) {
        if (value) {
          ...
          this.addressList = []
          this.$store.commit('setDetails', { value: {}, moduleName: this.moduleName })
        }
      }
    }
  },
          ...
          <Row gutter={10}>
            <Col span={24}>
              <Form.Item label="所属组织">
                {this.form.getFieldDecorator('organId', {
                  ...
                  rules: [{ required: true, type: 'array', message: '请选择组织!', trigger: 'change' }]
                })(<CascaderOrgan />)}
              </Form.Item>
            </Col>
            <Col span={12}>
            ...
            <Col span={12}>
              <Form.Item label="性别">
                {this.form.getFieldDecorator('gender', {
                  initialValue: this.details.gender
                })(
                  <Radio.Group>
            ...
            <Col span={12}>
              <Form.Item label="电子邮箱">
                {this.form.getFieldDecorator('email', {
                  ...
                  rules: [{ required: false, type: 'email', message: '格式错误!', trigger: 'blur' }]
                })(<Input placeholder="请输入" allowClear />)}
              </Form.Item>
            </Col>
            <Col span={12}>
            ...
            <Col span={12}>
              <Form.Item label="联系地址">
                {this.form.getFieldDecorator('addressList', {
                  initialValue: this.addressList
                })(
                  <Cascader
                    placeholder="请选择省市区"
                    expandTrigger={'hover'}
            ...
            <Col span={12}>
              <Form.Item label="">
                {this.form.getFieldDecorator('address', {
                  initialValue: this.details.address
                })(<Input placeholder="请输入" allowClear />)}
              </Form.Item>
            </Col>
            <Col span={24}>
