      ...
      <DragModal {...attributes}>
        <Form class="bnm-form-grid" colon={false}>
          <Form.Item label="线索标题">
            {
              this.form.getFieldDecorator('title', {
                ...
                rules: [{ required: true, message: '请输入线索标题', trigger: 'blur' }]
              })(
          ...
          <Form.Item label="线索来源" class={'half'}>
            {
              this.form.getFieldDecorator('cluesResource', {
                initialValue: this.currentItem.cluesResource
              })(
                <Input placeholder="请输入" allowClear />
              )
            }
          ...
          <Form.Item label="所属行业" class={'half'}>
            {
              this.form.getFieldDecorator('industry', {
                initialValue: this.currentItem.industry || undefined
              })(
                <Select
                  placeholder="请选择所属行业"
                  allowClear
          ...
          <Form.Item label="采集人" class={'half'}>
            {
              this.form.getFieldDecorator('gatherName', {
                initialValue: this.currentItem.gatherName
              })(
          ...
          <Form.Item label="采集时间" class={'half'}>
            {
              this.form.getFieldDecorator('gatherTime', {
                initialValue: this.currentItem.gatherTime
                  ? moment(this.currentItem.gatherTime, 'YYYYMMDDHHmmss')
                  : ''
              })(
                <DatePicker
                  showTime
          ...
          <Form.Item label="线索描述">
            {
              this.form.getFieldDecorator('cluesDescription', {
                ...
                <Input.TextArea placeholder={'请输入线索描述'} />
              )
            }
          </Form.Item>
          ...
          <Form.Item label="跟进成员" class={'half'}>
            {
              this.form.getFieldDecorator('memberId', {
                initialValue: this.currentItem.memberId
              })(
                <Select
