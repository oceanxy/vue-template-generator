...
import { Col, Form, Input, Row, DatePicker, Select } from 'ant-design-vue'
...
export default Form.create({})({
  ...
  computed: {
    ...mapState(['roomList', 'bussienssSelect'])
  },
  mounted() {},
  watch: {
    visible: {
      ...
      async handler(value) {
        if (value) {
          ...
          this.getBussienss(this.currentItem.companyName || '')
        }
      }
    }
  },
            ...
            <Col span={24}>
              <Form.Item label="会议室">
                {this.form.getFieldDecorator('roomId', {
                  ...
                  rules: [{ required: true, message: '请选择会议室!', trigger: 'change' }]
                })(
                  <Select
              ...
              <Form.Item label="占用时段">
                {this.form.getFieldDecorator('appointmentStartTime', {
                  initialValue: this.currentItem.appointmentStartTimeStr
                    ...
                    : undefined,
                  rules: [{ required: true, type: 'object', message: '请选择开始时间!', trigger: 'change' }]
                })(
              ...
              <Form.Item label="">
                {this.form.getFieldDecorator('appointmentEndTime', {
                  initialValue: this.currentItem.appointmentEndTimeStr
                    ...
                    : undefined,
                  rules: [{ required: true, type: 'object', message: '请选择结束时间!', trigger: 'change' }]
                })(
                  <DatePicker showTime={true} format="YYYY-MM-DD HH:mm:ss" placeholder="请选择" allowClear></DatePicker>
                )}
              </Form.Item>
            ...
            <Col span={24}>
              <Form.Item label="预约说明">
                {this.form.getFieldDecorator('description', {
                  ...
                  rules: [{ required: true, type: 'string', message: '请输入预约说明!', trigger: 'blur' }]
