...
import { Form, Input, InputNumber, Radio, Rate, Switch } from 'ant-design-vue'
    ...
    return (
      <DragModal {...attributes}>
        ...
        >
          ...
          {/*          value: 'id'*/}
          {/*        }}*/}
          {/*        treeDefaultExpandedKeys={[this.organizationTree?.list?.[0]?.id, this.currentItem.organId]}*/}
