            ...
            <Spin spinning={this.pendingOrders.loading}>
              {
                this.form.getFieldDecorator('billIds', {
                  initialValue: [],
                  rules: [{ required: true, type: 'array', message: '请选择缴费账单!', trigger: 'change' }]
                })(
                ...
                <Form.Item>
                  {
                    this.form.getFieldDecorator('amount', {
                      rules: [{ required: true, type: 'number', message: '请输入缴费金额!', trigger: 'blur' }]
                    })(
                      <InputNumber
                ...
                <Form.Item>
                  {
                    this.form.getFieldDecorator('realAmount', {
                      rules: [{ required: true, type: 'number', message: '请输入实缴金额!', trigger: 'blur' }]
                    })(
                      <InputNumber
                        precision={2}
                        style={{ width: '100%' }}
          ...
          <Form.Item label="备注">
            {
              this.form.getFieldDecorator('remark', {
                rules: [{ required: this.remarkRequired, message: '请输入备注', trigger: 'blur' }]
              })(
