  ...
  render() {
    return (
      <Form layout="inline" onSubmit={this.onSubmit} colon={false} class="tg-inquiry">
        <Form.Item>{this.form.getFieldDecorator('fullName')(<Input placeholder="姓名" allowClear />)}</Form.Item>
        <Form.Item>{this.form.getFieldDecorator('workType')(<Input placeholder="工种" allowClear />)}</Form.Item>
        <Form.Item>
          <Space>
