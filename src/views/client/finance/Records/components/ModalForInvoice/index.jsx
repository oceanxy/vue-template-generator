...
export default Form.create({})({
  ...
  render() {
    const attributes = {
      ...
      on: {
        cancel: () => this.onCancel('showModalForInvoice')
      }
    }
        ...
        <Form
          ...
          <Form.Item label="电话">
            {this.form.getFieldDecorator('tel', {
              initialValue: this.currentItem.tel
            })(<Input />)}
          </Form.Item>
          ...
          <Form.Item label="开户银行">
            {this.form.getFieldDecorator('kh', {
              initialValue: this.currentItem.kh
            })(<Input />)}
          </Form.Item>
          <Form.Item label="银行账号">
            {this.form.getFieldDecorator('acc', {
              initialValue: this.currentItem.acc
            })(<Input />)}
          </Form.Item>
          <Form.Item label="备注">
