      ...
      >
        ...
        >
          <Descriptions column={1}>
            ...
            <Descriptions.Item label="签约状态">已签约（签约时间：2022-05-18 19:51，经办人：李卢,15865854254 ）</Descriptions.Item>
            <Descriptions.Item>
        ...
        >
          <Descriptions column={1}>
            ...
            <Descriptions.Item label="合同期限">2022-05-18 至 2023-05-17（5年）</Descriptions.Item>
            <Descriptions.Item label="生成时间">2022-05-18 19:51</Descriptions.Item>
            <Descriptions.Item label="签约状态">已签约（签约时间：2022-05-18 19:51，经办人：陈强,15232635585 ）</Descriptions.Item>
            <Descriptions.Item>
              <div class="contract-status">签约审核中，请耐心等待</div>
            </Descriptions.Item>
            <Descriptions.Item>
        ...
        >
          <Descriptions column={1}>
            ...
            <Descriptions.Item label="合同期限">2022-05-18 至 2023-05-17（5年）</Descriptions.Item>
            <Descriptions.Item label="生成时间">2022-05-18 19:51</Descriptions.Item>
            <Descriptions.Item label="签约状态">已签约（签约时间：2022-05-18 19:51，经办人：陈永森,13883191521 ）</Descriptions.Item>
            <Descriptions.Item>
              <div class="contract-status">签约审核中，请耐心等待</div>
            </Descriptions.Item>
            <Descriptions.Item>
        ...
        >
          <Descriptions column={1}>
            ...
            <Descriptions.Item label="合同期限">2022-05-18 至 2023-05-17（5年）</Descriptions.Item>
            <Descriptions.Item label="生成时间">2022-05-18 19:51</Descriptions.Item>
            <Descriptions.Item label="签约状态">已签约（签约时间：2022-05-18 19:51，经办人：张思雨,13852658547 ）</Descriptions.Item>
            <Descriptions.Item>
              <div class="contract-status">签约审核中，请耐心等待</div>
            </Descriptions.Item>
            <Descriptions.Item>
